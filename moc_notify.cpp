...
**
** Created: Sun Mar 9 14:06:25 2014
...
static const char qt_meta_stringdata_Notify[] = {
    "Notify\0"
};
...
const QMetaObjectExtraData Notify::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject Notify::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_Notify,
      qt_meta_data_Notify, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &Notify::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Notify))
